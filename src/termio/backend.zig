...
pub const Config = union(Kind) {
    ...
    /// Pipe forwards writes via callback and accepts externally fed reads.
...
pub const Backend = union(Kind) {
    ...
    pub fn threadEnter(
        ...
        switch (self.*) {
            ...
            .pipe => |*pipe| try pipe.threadEnter(alloc, io, td),
        }
    }
    ...
    pub fn focusGained(
        ...
        switch (self.*) {
            ...
            .pipe => |*pipe| try pipe.focusGained(td, focused),
        }
    }
    ...
    pub fn resize(
        ...
        switch (self.*) {
            ...
            .pipe => |*pipe| try pipe.resize(grid_size, screen_size),
        }
    }
    ...
    pub fn queueWrite(
        ...
        switch (self.*) {
            ...
            .pipe => |*pipe| try pipe.queueWrite(alloc, td, data, linefeed),
        }
    }
    ...
    pub fn childExitedAbnormally(
        ...
        switch (self.*) {
            ...
            .pipe => |*pipe| try pipe.childExitedAbnormally(
                gpa,
                t,
                exit_code,
                runtime_ms,
